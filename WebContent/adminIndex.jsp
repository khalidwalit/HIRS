                ...
                <div class="x_panel">
                  <div class="x_content">
                    <div class="row">
					  ...
					  <c:url value="/manageStaff" var="url">
	<c:param name="viewStaff" value="manageStaff"/>
</c:url>
...
<c:forEach items="${staff}" var="p">
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>${p.staffID}</i></h4>
                            <div class="left col-xs-7">
                              <h2>${p.staffName}</h2>
                              <ul class="list-unstyled">
                                <li> ${p.staffEmail}</li>
                                <li><i class="fa fa-phone"></i> Phone : ${p.staffPhoneNo}</li>
                              </ul>
                            </div>
                            <div class="right col-xs-5 text-center">
                              <img src="production/images/user.png" alt="" class="img-circle img-responsive">
                            </div>
                          </div>
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              ...
                              <input type="hidden" id="username" name="username" readOnly value="${p.staffID}">
