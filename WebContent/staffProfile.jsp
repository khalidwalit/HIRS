              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="deleteStaff" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="form-control col-md-7 col-xs-12" for="first-name">${p.staffName}</span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="form-control col-md-7 col-xs-12" for="first-name">${p.staffEmail}</span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="form-control col-md-7 col-xs-12" for="first-name"> ${p.staffPhoneNo}</span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="form-control col-md-7 col-xs-12" for="first-name">${p.staffAddress}</span>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="manageStaff" class="btn btn-primary">Cancel</a>
